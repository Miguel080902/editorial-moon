          ...
          <div className="grid md:grid-cols-4 gap-8 text-center">
            ...
            <div className={`transition-all duration-700 ${statsVisible ? 'translate-y-0 opacity-100' : 'translate-y-5 opacity-0'}`} style={{ transitionDelay: '800ms' }}>
              <svg className="w-12 h-12 mx-auto mb-2" fill="currentColor" viewBox="0 0 24 24">
                <path d="M18.6 6.62c-1.44 0-2.8.56-3.77 1.53L12 10.77 10.23 7.5c-.84-.84-1.96-1.31-3.16-1.31s-2.32.47-3.16 1.31c-.84.84-1.31 1.96-1.31 3.16s.47 2.32 1.31 3.16l.88.88c-.4.4-.62.94-.62 1.5 0 .56.22 1.1.62 1.5.4.4.94.62 1.5.62.56 0 1.1-.22 1.5-.62l.88.88c.84.84 1.96 1.31 3.16 1.31s2.32-.47 3.16-1.31c.84-.84 1.31-1.96 1.31-3.16s-.47-2.32-1.31-3.16l-.88-.88c.4-.4.62-.94.62-1.5 0-.56-.22-1.1-.62-1.5l.88-.88c.84-.84 1.31-1.96 1.31-3.16s-.47-2.32-1.31-3.16C20.92 7.18 19.76 6.62 18.6 6.62zM7.07 8.91c.5-.5 1.17-.76 1.86-.76s1.36.26 1.86.76L12 10.77l1.51-1.86c.5-.5 1.17-.76 1.86-.76s1.36.26 1.86.76c.5.5.76 1.17.76 1.86s-.26 1.36-.76 1.86l-1.86 1.51 1.86 1.51c.5.5.76 1.17.76 1.86s-.26 1.36-.76 1.86c-.5.5-1.17.76-1.86.76s-1.36-.26-1.86-.76L12 13.23l-1.51 1.86c-.5.5-1.17.76-1.86.76s-1.36-.26-1.86-.76c-.5-.5-.76-1.17-.76-1.86s.26-1.36.76-1.86l1.86-1.51-1.86-1.51c-.5-.5-.76-1.17-.76-1.86S6.57 9.41 7.07 8.91z"/>
              </svg>
